  ...
  <div class="container col-md-9" >
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h2 class="m-3 font-weight-bold text-primary">LISTE DES CLIENTS</h2>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                <table class="table table-bordered table-striped table-sm">
                            <thead>
                                ...
                                <th><h4><strong>PRENOM</strong></h4></th>
                                <th><h4><strong>ADRESSE</strong></h4></th>
                                <th><h4><strong>TELEPHONE</strong></h4></th>
                            ...
                            <?php
                                ...
                                {?>
                                    ...
                                    <tr>
                                    <td><h5><?=$client[0]?></h5></td>
                                    <td><h5><?=$client[1]?></h5></td>
                                    <td><h5><?=$client[2]?></h5></td>
                                    <td><h5><?=$client[3]?></h5></td>
                                    <td><h5><?=$client[4]?></h5></td>
                                    <td>
                                    <a href="modifierClients?edit=<?php echo $client[0]; ?>"
                                    class = "btn btn-info">Modifier</a>
                                                                      
                                    <a href="suppression.clients?delete=<?php echo $client[0]; ?>"
